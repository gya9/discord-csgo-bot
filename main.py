...
async def on_message(message):
    if client.user != message.author:
        ...
        if message.content.startswith("!lobby"):
            ...
            key={}&format=csv&steamids={}".format(key_data_str, steam_id)
            ...
            m1 = "{}さんがMMを募集しています　↓のリンクから参加(CSGOが起動します)".format(steam_name)
